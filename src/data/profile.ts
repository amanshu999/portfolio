...
export const profile = {
  ...
  linkedin: "https://www.linkedin.com/in/amanshu404/", // Leave empty if not available
  ...
  projects: [
    {
      id: "multi-tool-web-app",
      title: "Multi-Tool Web Application",
      description: "Built a responsive tools website with multiple utility-based web tools. Used HTML, CSS, and JavaScript for UI and functionality. Focused on usability, performance, and clean project structure.",
      techStack: ["HTML", "CSS", "JavaScript"],
      liveLink: "https://xelotools.vercel.app/",
      status: "completed",
    },
    {
      id: "2",
